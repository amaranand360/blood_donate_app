...
class _HelpScreenState extends State<HelpScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> contactData = [
    ...
    {'icon': Icons.facebook, 'title': 'Facebook', 'contact': '@DonorConnect'},
    {'icon': Icons.flutter_dash, 'title': 'Twitter', 'contact': '@DonorConnect'},
    {'icon': Icons.camera_alt, 'title': 'Instagram', 'contact': '@DonorConnect'},
  ];
